...
fun BlockInteraction.Companion.buildMessageBlock(
  uuid: String,
  block_id: String,
  flow_id: String,
  ...
  selected_exit_id: String? = null,
  type: String = MessageBlock.MESSAGE_TYPE,
  origin_block_interaction_id: String? = null,
...
fun BlockInteraction.Companion.build(
  uuid: String,
  block_id: String,
  flow_id: String,
  entry_at: Instant = createFormattedDate(),
